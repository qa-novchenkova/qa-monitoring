...
Проект разработан с использованием AI-агента в Cursor (агентная LLM-система): генерация кода автотестов и монитора, настройка CI/CD, отладка и подготовка документации. Это практический пример применения LLM-агентов в QA-инженерии — от постановки задачи до рабочего результата.
